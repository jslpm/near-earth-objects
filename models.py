...
class NearEarthObject:
    ...
    def __init__(self, designation='', name=None, diameter=float('nan'), hazardous=False):
        ...
        :param designation: The primary designation for the NEO
        :param name: The IAU name for the NEO
        :param diameter: The diameter, in kilometers, of the NEO
        :param hazardous: Whether or not the NEO is potentially hazardous
        :param approaches: A collection of NEOs close approaches to Earth
...
class CloseApproach:
    ...
    # How can you, and should you, change the arguments to this constructor?
    # If you make changes, be sure to update the comments in this file.
    def __init__(self, time='0001-Jan-01 00:00', distance=0.0, velocity=0.0, neo=None):
    ...
    def __str__(self):
        ...
        # The project instructions include one possibility. Peek at the __repr__
        # method for examples of advanced string formatting.
        return f"At {datetime_to_str(self.time)}, '{self.neo.fullname}' " + \
            "approaches Earth at a distance of " + \

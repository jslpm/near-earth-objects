...
def write_to_json(results, filename):
    ...
    ca_fieldnames = ('datetime_utc', 'distance_au', 'velocity_km_s', 'neo')
    ...
    with open(filename, 'w') as outfile:
        for result in results:
            ...
            ca_data = (date, distance, velocity, neo_dict)
            ca_dict = dict(zip(ca_fieldnames, ca_data))
            
            output.append(ca_dict)
